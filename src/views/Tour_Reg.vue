  ...
  >
    <div class="max-w-4xl mx-auto">
      ...
      <div class="text-center mb-12">
        <div
          class="inline-block p-4 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-full mb-6 shadow-2xl"
        >
          <svg
        ...
        <p class="text-gray-600 text-lg">
          Yangi musobaqa yarating va ma'lumotlarni to'ldiring
        </p>
      </div>

      <!-- Form Card -->
      <div
        class="bg-white rounded-3xl shadow-2xl p-8 md:p-12 backdrop-blur-sm border border-gray-100"
      >
        <form @submit.prevent="handleSubmit" class="space-y-8">
          <!-- MUSOBAQA RASMI -->
          <div class="form-section">
            <label
              class="block text-lg font-bold text-gray-800 mb-4 flex items-center gap-3"
            >
              <div
            ...
            <div class="relative">
              ...
              >
                <div v-if="!imagePreview" class="text-center">
                  <svg
                    class="w-16 h-16 text-indigo-400 mx-auto mb-4 group-hover:scale-110 transition duration-300"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <div v-else class="relative w-full h-full">
                  ...
                  />
                  <div
                    class="absolute inset-0 bg-black bg-opacity-40 rounded-2xl flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300"
                  >
            ...
            <div class="relative">
              ...
              >
                <div class="flex items-center gap-4">
                  <div
                    class="w-14 h-14 bg-green-200 rounded-xl flex items-center justify-center group-hover:scale-110 transition duration-300"
                  >
                    <svg
          ...
          <div class="form-section">
            ...
            <p class="text-sm text-gray-500 mt-2 text-center">
              Ishtirokchilarni registratsiya qilish uchun o'z tasdiqlash
              kodingizni kiriting
            </p>
          </div>
      ...
      >
        <div
          class="bg-white rounded-2xl p-8 max-w-md mx-4 shadow-2xl transform transition-all"
        >

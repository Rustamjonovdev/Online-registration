          ...
          <div class="form-group">
            ...
            <div class="relative group">
              ...
              <input 
                ...
                type="text" 
                class="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition duration-200 outline-none hover:border-gray-300"
          ...
          <div class="pt-6">
            ...
            >
              <span class="flex items-center justify-center gap-3">
                ...
                {{ isFormValid ? "Ro'yxatdan o'tish" : "Barcha maydonlarni to'ldiring" }}
              </span>
            </button>
          </div>
        </form>
